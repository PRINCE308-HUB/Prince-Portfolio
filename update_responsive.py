...
def update_file():
    ...
    html = html.replace('text-5xl font-bold', 'text-4xl md:text-5xl font-bold')
    ...
    # 7. Update script.js for navbar toggle
...
/* ================= ACTIVE NAVBAR ================= */
"""
    if 'MOBILE NAVBAR' not in js:
        js = js.replace('/* ================= ACTIVE NAVBAR ================= */', nav_js)
        with open('script.js', 'w', encoding='utf-8') as f:
            f.write(js)
        print("JS updated.")
    
    # 8. Add fade-in-down animation to Tailwind config if possible or just use custom CSS
